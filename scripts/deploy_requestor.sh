...
near call $stakeToken storage_deposit "{\"account_id\": \"$accountId\"}" --accountId $accountId --amount 0.00125 --gas=300000000000000
...
near call $stakeToken near_deposit "{}" --accountId $accountId --amount 2 --gas=300000000000000
